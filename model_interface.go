...
type Interface struct {
  ...
  Input          string                  `db:"input"          json:"input,omitempty"           yaml:"input"          gorm:"column:input;type:jsonb;"`
  Output         string                  `db:"output"         json:"output,omitempty"          yaml:"output"         gorm:"column:output;type:jsonb;"`
}
